                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="tabla-registros--fila">
                                        ...
                                        <td class="tabla-registros--columna_icon"><a href="../modificaciones/modificarResguardatario.php?id=<?php echo $row['resguardatario']; ?>"><img src="../logos/editar.png" alt=""></td>
                                    </tr>
                            </tbody>
                        <?php } ?>
                        </table>
